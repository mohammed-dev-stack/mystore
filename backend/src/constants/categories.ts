 ...
 */
export const RESTRICTED_CATEGORIES: readonly string[] = ["ملابس نسائية", "فساتين", "أزياء غير لائقة"];
...
/**
 * TypeScript type representing any allowed category value.
 * Example usage: `const cat: AllowedCategory = "electronics";`
 */
 ...
 */
export const isRestrictedCategory = (category: string): boolean => {
